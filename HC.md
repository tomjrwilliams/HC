...
So that we have a reference case for comparison, here is the return series of the original indicator above (with the volatility cut-off) over the period for which we have event data (only starting in late 2019).
